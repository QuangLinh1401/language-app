...
const MODULES = [
  { to: "/vocabulary", icon: "/icons/vocabulary.svg", anim: "/icons/vocabulary.lottie.json", bg: "var(--teal-soft)", name: "Vocabulary", desc: "5000 words, A1 to B2", zhDesc: "2600 từ HSK1–HSK6 · 汉语" },
          ...
          <div className="modal-sheet" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 380 }}>
            ...
            <div className="modal-scroll" style={{ paddingTop: 24 }}>
              ...
              {[
                ...
                { code: "zh", flag: "🇨🇳", name: "中文 (Tiếng Trung)", desc: "HSK1–HSK6 · 2600 từ · ngữ pháp · nghe · đọc · nói" }
              ].map((opt) => (
                <button
                  key={opt.code}
                  onClick={() => {
